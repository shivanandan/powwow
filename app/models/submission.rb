class Submission < ActiveRecord::Base
	...
	validates_presence_of :introduction, :methods, :results, :discussion, :title, :gps_lat, :gps_lng, :previous_attendance, :bursary, :presenter, :current_institution, :keywords
	...
	validates_length_of :reason_for_bursary, :maximum => 100, :too_long => " must be under 20 words.", :tokenizer => lambda { |str| str.split }
end
