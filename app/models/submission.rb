class Submission < ActiveRecord::Base
	...
	validates_presence_of :introduction, :methods, :results, :discussion, :title, :authors, :gps_lat, :gps_lng, :poster, :previous_attendance, :previous_bursary, :bursary
	...
	validates_length_of :discussion, :maximum => 20, :too_long => " must be under 20 words.", :tokenizer => lambda { |str| str.split }
end
